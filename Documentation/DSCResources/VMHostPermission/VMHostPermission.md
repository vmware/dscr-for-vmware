...
| **PrincipalName** | Key | string | The name of the User to which the Permission applies. If the User is a **Domain User**, the Principal name should be in the following format: `<Domain Name>`/`<User name>`. Example Principal name for Domain User: 'MyDomain/MyDomainUser'. ||
